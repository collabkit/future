 ...
 * 
 * This is a hybrid node/browser module. Beware, in node, not specifying a target when using Class
 * will result in the class being declared globally - just like in a browser.
 * 
...
exports.Class = function( target, name, model ) {
	...
	target[name] = function () {
		if ( 'has' in model ) {
			exports.apply(
				model.has, function ( val, key, that ) {
		...
		if ( 'can' in model ) {
			exports.apply(
				exports.mix( {}, exports.Class.generic, model.can ),
				function ( fn, key, that ) {
					if ( key !== 'initialize' ) {
						that[key] = function () {
