...
/**
 * Call a function to each member of an object.
 * 
 * @param object Object: Object to call function on
 * @param fn Function: Function to call on each member; takes 3 arguments, value, index, and data
 * @param data Mixed: Additional data to pass to the function (optional)
 */
function iterate( object, fn, data ) {
	for ( var i in object ) {
		if ( object.hasOwnProperty( i ) ) {
			fn.call( object, object[i], i, data ) ;
		}
	}
};
