...
Store.prototype.createBlobFromString = function(str, callback) {
	this.writeGitStream(['hash-object', '-w', '--stdin'], callback).end(str);
};

Store.prototype.createBlobFromObject = function(obj, callback) {
	this.createBlobFromString(JSON.stringify(obj));
};
...
if (module.parent === null) {
	...
	if (args[0] == 'create-blob') {
		...
		console.log('Actions: create-blob, read-blob, create-tree, commit-tree');
		process.exit(1);
	}
}
